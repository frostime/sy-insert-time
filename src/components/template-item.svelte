<!--
 ...
 LastEditTime : 2024-08-18 23:50:32
 Description  : 
-->
<script lang="ts">
    ...
    const TemplatesStore: ReturnType<typeof useTemplates> = getContext("TemplatesStore");
...
<div class="flex col conf-item" style="gap: 3px;">
    <div class="flex">
        <div class="flex-1" style="font-size: 1.1rem; font-weight: bold;">{key}</div>
        <div><input class="b3-switch fn__flex-center" type="checkbox" bind:checked={template.enabled}/></div>
    </div>
...
<style lang="scss">
    ...
    .conf-item > div.fn__flex-1 {
        align-items: center;
    }
    .conf-item > div.fn__flex-1 > span {
